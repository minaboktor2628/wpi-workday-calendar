...
export const metadata: Metadata = {
  title: "WPI Workday To Outlook",
  description:
    "Upload your workday calender and convert it into a Outlook uploadable file.",
  icons: [
    {
      rel: "icon",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased max-w-2xl mt-8 mx-auto dark`}
      >
        <TooltipProvider>
